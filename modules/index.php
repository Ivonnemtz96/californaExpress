            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
               <div class="services-section-title z-index  pb-50">
                  ...
                  <h2 class="tp-section__title mb-10 wow fadeInUp   " data-wow-duration=".9s"
                     data-wow-delay=".4s">Safe & Reliable
                     Cargo Solutions
                  </h2>
               </div>
            </div>
      ...
      <div class="tp-about__wrap pt-110 pb-60">
         <div class="container">
            <div class="row align-items-start">
               <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-12 wow fadeInLeft   "
                  data-wow-duration=".9s" data-wow-delay=".5s">
                  <div class="tp-about__content">
                     <div class="about-section-title z-index  pb-50">
                        <div class="tp-section__subtitle tp-section__subtitle-before mb-15 p-relative">KNOW ABOUT PORTX
                        </div>
               ...
               <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-12 wow fadeInRight   "
                  data-wow-duration=".9s" data-wow-delay=".5s">
      ...
      <div class="container">
         <div class="row">
            <div class="col-xl-7 col-lg-6 col-md-12">
               <div class="tp-choose__content">
                  <div class="choose-section-title z-index">
                     <div
                        class="tp-section__subtitle tp-section__subtitle-before mb-15 p-relative wow fadeInUp   "
                     ...
                     <p class="mb-35 wow fadeInUp   " data-wow-duration=".9s" data-wow-delay=".5s">Logistics is a
                        ...
                        comprehensive solutions for warehousing, transportation and a host of <br> logistics services
                     </p>
                  </div>
                  <div class="tp-choose__list mb-50 wow fadeInUp   " data-wow-duration=".9s"
                     data-wow-delay=".7s">
            ...
            <div class="col-xl-5 col-lg-6 col-md-12">
               <div class="tp-contact__inner-column wow fadeInDown   " data-wow-duration=".9s"
                  data-wow-delay=".5s">
                  <!-- Contact Form -->
                              ...
                              <div class="team__thumb fix">
                                 ...
                                 <div class="team__wrapp">
                                    <div class="team__content">
                                       <h3 class="team__title-1"><a href="team-details.html">Helen Wilmore</a></h3>
